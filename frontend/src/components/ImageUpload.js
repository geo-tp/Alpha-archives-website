    ...
    return (
      <form className="main-image-upload" onSubmit={(e) => this.uploadFiles(e)}>
        ...
        <div className="main-image-upload__previews">
          <label className="main-image-upload__previews__title">
            Previews ({this.fileObj.length} images)
          </label>
          <button
            className="button-base button-reset"
            type="button"
              ...
              <div className="main-image-upload__previews__box__element">
                ...
                {this.state.uploaded ? (
                  this.state.fileResponse[index] == 208 ? (
                    ...
                    <label className="main-image-upload__previews__box__element__response success">
        ...
        <button
          ...
          type="submit"
          disabled={this.fileArray.length ? false : true}
        >
          {this.state.loading
            ? "Loading " + this.state.loadingCount + "/" + this.fileArray.length
            : "Upload"}
        </button>
